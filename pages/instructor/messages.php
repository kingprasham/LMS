...
<div class="dashboard-wrapper">
    <?php renderInstructorSidebar('messages'); ?>
    ...
    <main class="dashboard-main" id="dashboardMain">
        ...
        <div class="dashboard-header fade-in-up">
            <div class="header-content">
                ...
                <p class="dashboard-subtitle">Communicate with students and administrators</p>
            </div>
                ...
                <div class="message-list">
                    <div class="message-item active">
                        <div class="message-avatar">
                            <img src="https://ui-avatars.com/api/?name=Sarah+Wilson&background=4f46e5&color=fff" alt="Sarah Wilson">
                        </div>
                        <div class="message-preview">
                            <div class="message-header">
                                <span class="message-name">Sarah Wilson</span>
                                <span class="message-time">1h ago</span>
                            </div>
                            <p class="message-text">Question about Assignment 3...</p>
                        </div>
                    ...
                    <div class="message-item">
                        ...
                        <div class="message-preview">
                            <div class="message-header">
                                <span class="message-name">Admin Team</span>
                                <span class="message-time">3h ago</span>
                            </div>
                            <p class="message-text">Course approval notification</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="message-content">
                <div class="message-content-header">
                    <div class="message-user-info">
                        <img src="https://ui-avatars.com/api/?name=Sarah+Wilson&background=4f46e5&color=fff" alt="Sarah Wilson" class="message-user-avatar">
                        <div>
                            <h3 class="message-user-name">Sarah Wilson</h3>
                            <p class="message-user-role">Student - Web Development Course</p>
                        </div>
                    </div>
                ...
                <div class="message-thread">
                    <div class="message-bubble received">
                        <div class="message-bubble-content">
                            <p>Hi Professor, I have a question about Assignment 3. Could you clarify the requirements for the final section?</p>
                            <span class="message-bubble-time">Today at 3:30 PM</span>
                        </div>
                    </div>

                    <div class="message-bubble sent">
                        <div class="message-bubble-content">
                            <p>Of course! The final section should include a detailed analysis of your implementation. I'll send you the rubric.</p>
                            <span class="message-bubble-time">Today at 4:15 PM</span>
                        </div>
                    </div>
                </div>
